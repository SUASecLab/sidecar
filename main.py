...
spec.path(
    ...
    operations=dict(
        get=dict(
            ...
            responses = {
                "200": {
                    "description": "Token was issued and is being returned. The token is an empty string if a token was required for the Jitsi Meet room and exam mode is enabled for that user.",
